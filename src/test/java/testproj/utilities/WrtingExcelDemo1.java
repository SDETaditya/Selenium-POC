...
public class WrtingExcelDemo1 {
	...
	public static void main(String[] args) throws IOException {
		...
		String filePath=System.getProperty("user.dir")+"/src/test/java/testproj/testdata/LoginData1.xlsx";
		FileOutputStream outstream=new FileOutputStream(filePath);
		workbook.write(outstream);
		
		outstream.close();
		
		System.out.println("Logindata1.xls file written successfully...");
	}
